...
**Not yet built (later phases):** per-target checkout/webhook activation (Phase F, see above), external websites/social channels admin UX polish (Phase E), Dashboard target visibility beyond the selection panel itself, and analytics/Rewards-event wiring (Phase H).
